...
class ResNet(nn.Module):
    ...
    # def OUT(self, x, with_latent=False, fake_relu=False, no_relu=False):
    #     out = F.relu(self.bn1(self.conv1(x)))
    #     out = self.layer1(out)
    #     feature1 = out
    #     out = self.layer2(out)
...
def ResNet18(args, **kwargs):
    if args.dataset == 'gtsrb':
        return ResNet(BasicBlock, [2, 2, 2, 2], num_classes=43, ** kwargs)
    else:
        return ResNet(BasicBlock, [2, 2, 2, 2], num_classes=10, ** kwargs)
